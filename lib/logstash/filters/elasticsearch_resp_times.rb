...
class LogStash::Filters::ElasticsearchRespTimes < LogStash::Filters::Base
...
#       }
#
  config_name "elasticsearch_resp_times"
...
end # class LogStash::Filters::ElasticsearchRespTimes
